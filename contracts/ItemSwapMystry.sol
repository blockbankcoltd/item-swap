...
contract ItemSwapMystry is ERC721, Ownable, ReentrancyGuard, PaymentSplitter {
  ...
  function presaleMint(address account, uint256 _amount)
    external
    payable
    onlyAccounts
  {
