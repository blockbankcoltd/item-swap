...
import logodark from "../../assets/images/logo/source/4_Horizontal_dark_mode.png";
import logofooter from "../../assets/images/logo/source/4_Horizontal_dark_mode.png";
const Footer = () => {
  const accountList = [
    {
      title: "Authors",
            ...
            <div className="col-lg-3 col-md-12 col-12">
              <div className="widget widget-logo">
                ...
                <p className="sub-widget-logo">
                  Discover Games, invest early for high returns, Earn and Win.
                </p>
              </div>
            </div>
